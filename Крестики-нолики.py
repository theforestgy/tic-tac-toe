...
playerturn=ttk.Label(root,text="   Ход игрока 1  ")
playerturn.grid(row=3,column=0,sticky='snew',ipadx=40,ipady=40)

playerdetails=ttk.Label(root,text="    Игрок 1 - X\n\n    Игрок 2 - O")
playerdetails.grid(row=3,column=2,sticky='snew',ipadx=40,ipady=40)

res=ttk.Button(root,text='Начать сначала')
...
def ButtonClick(id):
    ...
    if( bu1['text']=='X' and bu2['text']=='X' and bu3['text']=='X' or
        ...
        bu3['text']=='X' and bu5['text']=='X' and bu7['text']=='X'):
            disableButton()
            c=1
            tkinter.messagebox.showinfo("Крестики-нолики","Победил 1-й игрок")
        ...
        bu3['text']=='O' and bu5['text']=='O' and bu7['text']=='O'):
            disableButton()
            c=1
            tkinter.messagebox.showinfo("Крестики-нолики","Победил 2-й игрок")
    elif b==9:
            disableButton()
            c=1
            tkinter.messagebox.showinfo("Крестики-нолики","Ничья")

    if a==1 and c==0:
        playerturn['text']="   Ход игрока 1   "
    elif a==0 and c==0:
        playerturn['text']="   Ход игрока 2   "
